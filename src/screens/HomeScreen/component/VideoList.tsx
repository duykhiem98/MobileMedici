    ...
    return (
        <View style={styles.container}>
            <Video
                ...
                style={!isFullScreen ? styles.backgroundVideo : styles.backgroundVideoFullScreens} // any style you want
            ...
            <MediaControls
                ...
                style={!isFullScreen ? styles.backgroundVideo : styles.backgroundVideoFullScreens}
                sliderStyle={
                    isFullScreen
                        ? {
